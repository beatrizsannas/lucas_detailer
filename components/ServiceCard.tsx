  ...
  return (
    <motion.div
      ...
      className={`
        ...
        bg-[#0F0F12] border border-white/5 cursor-pointer
        hover:border-brand-purple/50 transition-all duration-300
        hover:bg-[#16161c] hover:shadow-[0_5px_30px_rgba(168,85,247,0.1)]
    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full">
        <div className="flex-1 mb-4">
          <h3 className="text-lg md:text-xl font-bold text-gray-100 font-display mb-2 group-hover:text-brand-purple transition-colors leading-tight">
            {item.name}
          </h3>
          {item.description && (
        ...
        <div className="flex justify-between items-end border-t border-white/5 pt-4 mt-auto">
           <div className="flex items-center gap-1.5 text-brand-purple/80 text-xs font-medium group-hover:text-brand-purple transition-colors">
            <Plus size={14} />
            <span>Ver detalhes</span>
          </div>

          <div className="flex flex-col items-end">
            <span className="text-xs text-gray-500 mb-0.5">A partir de</span>
